...
export default class RegistrationForUser extends LightningElement {
    ...
    handleRegister(event)
    {
        ...
        if(this.lastName && this.phone && this.email && this.userName && this.password && this.confirmPassword)
        {
            ...
            .then((result) => {
                ...
                {   console.log('it stop here');
                    registerUser({lastName: this.lastName, phone:this.phone, email: this.email, username: this.userName, communityNickname: this.lastName, password: this.password })
                        .then((result) => {
    ...
    handleEmailChange(event)
    {
        if(event.target.value){
            ...
            this.userName = this.email + '.parking';
